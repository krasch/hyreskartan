const texts = {
    ...
    "5": {"sv": "5+", "en": "5+"},
    // additional filters
    "includeShortContracts": {"sv": "Inkludera korttidskontrakt", "en": "Include short term rentals"},
    "includeNewbuilds": {"sv": "Inkludera nyproduktion", "en": "Include newly built apartments"},
    // headings
    "rooms": {"sv": "Hur många rum?", "en": "How many rooms should the flat have?"},
    "apartmentType": {"sv": "Vilken typ av lägenhet söker du?", "en": "What kind of apartment are you looking for?"},
    "waitingTime": {"sv": "Hur länge har du stått i Bostadskön?", "en": "When did you join the bostadskö?"},
    "additionalFilters": {"sv": "Övrigt", "en": "Additional search filters"},
    // random stuff
    "year": {"sv": "år", "en": "year"}
}